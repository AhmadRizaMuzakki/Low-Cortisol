export default function Header({ onOpenSidebar }) {
    return (
      <header className="shrink-0 border-b border-gray-200/80 bg-white px-4 py-3 shadow-sm sm:px-6">
        <div className="mx-auto flex max-w-[1600px] flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            ...
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                aria-label="Cari"
                className="w-96 rounded-xl border border-gray-200 bg-gray-50 py-2.5 pr-4 pl-11 text-sm text-app-navy placeholder:text-app-muted transition-colors focus:border-app-primary/40 focus:bg-white focus:ring-2 focus:ring-app-primary/20 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center justify-end gap-4 sm:gap-5">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/80 py-1 pr-2 pl-1">
              <div className="hidden text-right sm:block">
                <p className="text-sm font-semibold leading-tight text-app-navy">Admin Utama</p>
                <p className="text-xs text-app-muted">Petugas TU</p>
              </div>
              <div
