...
import PenjadwalanTable from '../../../components/Penjadwalan/PenjadwalanComponent.jsx'
...
export default function PenjadwalanPage() {
  ...
  async function fetchList() {
    ...
    setError(null)
    try {
      const response = await getPenjadwalan()
      setItemList(parseListResponse(response.data))
    } catch (err) {
      console.error('Error fetching penjadwalan:', err)
  ...
  function handleNavigateToCreate() {
    navigate('/Penjadwalan/PenjadwalanResource/TambahPenjadwalan')
  }

  function handleItemDeleted(id) {
    setItemList((prev) => prev.filter((item) => item.id_jadwal !== id))
  }
